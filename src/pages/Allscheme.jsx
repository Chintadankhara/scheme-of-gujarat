    ...
    <>
      ...
      <div className="container rounded text-center">
        <form action="" method="post">
          <input required className="search-f shadow-sm" type="search" placeholder="Search Your Scheme" aria-label="search" />
          <button className="mt-1 mb-3 btn-f btn btn-dark shadow-sm border border-dark" type="submit"
            style={{ 'backgroundColor': 'brown' }}>Search</button>
        </form>
      </div>
